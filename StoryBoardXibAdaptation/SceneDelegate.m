...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    UIStoryboard *mtsb = [UIStoryboard storyboardWithName:@"MTSB" bundle:nil];
    MTTabBarController *tab = [mtsb instantiateViewControllerWithIdentifier:@"MTTabBarController"];
